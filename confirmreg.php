...
if(isset($_GET['code']))
{
   if($TayFireUsersite->ConfirmUser())
   {
        $TayFireUsersite->RedirectToURL("thank-you-regd.html");
   }
}
...
<!-- Form Code Start -->
<div id='tayfiresite'>
<form id='confirm' action='<?php echo $TayFireUsersite->GetSelfScript(); ?>' method='get' accept-charset='UTF-8'>
