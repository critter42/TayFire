...
{
   if($TayFireUsersite->ChangePassword())
   {
        $TayFireUsersite->RedirectToURL("changed-pwd.html");
   }
}
...
<!-- Form Code Start -->
<div id='tayfiresite'>
<form id='changepwd' action='<?php echo $TayFireUsersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
<fieldset >
